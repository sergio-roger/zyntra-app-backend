...
async function fixDatabase() {
  ...
  try {
    ...
    await client.query("UPDATE businesses SET plan = 'brandstart' WHERE plan = 'starter'");
    await client.query("UPDATE businesses SET plan = 'impulse_pro' WHERE plan = 'pro'");
    await client.query("UPDATE businesses SET plan = 'core_digital' WHERE plan = 'enterprise'");
    ...
    console.log('✨ Base de datos reparada con éxito. Ahora puedes iniciar el backend.');
  } catch (err) {
